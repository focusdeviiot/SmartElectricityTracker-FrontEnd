          ...
          <div className="flex flex-wrap justify-center gap-4 m-4">
            <div className="preview border-base-300 bg-base-100 rounded-box flex min-h-[6rem] min-w-[18rem] max-w-4xl flex-wrap items-center justify-center gap-2 overflow-x-hidden bg-cover bg-top p-4 [border-width:var(--tab-border)] undefined">
              <div className="stat">
                ...
                <div className="stat-value text-yellow-500">{data[key]["voltage"].toFixed(1)} V</div>
            ...
            <div className="preview border-base-300 bg-base-100 rounded-box flex min-h-[6rem] min-w-[18rem] max-w-4xl flex-wrap items-center justify-center gap-2 overflow-x-hidden bg-cover bg-top p-4 [border-width:var(--tab-border)] undefined">
              <div className="stat">
                ...
                <div className="stat-value text-yellow-500">{data[key]["current"].toFixed(3)} A</div>
                {/* <div className="stat-desc">21% more than last month</div> */}
              </div>
            </div>
            <div className="preview border-base-300 bg-base-100 rounded-box flex min-h-[6rem] min-w-[18rem] max-w-4xl flex-wrap items-center justify-center gap-2 overflow-x-hidden bg-cover bg-top p-4 [border-width:var(--tab-border)] undefined">
              <div className="stat">
                ...
                <div className="stat-value text-yellow-500">{data[key]["active_power"].toFixed(1)} W</div>
                {/* <div className="stat-desc">21% more than last month</div> */}
              </div>
            </div>
          </div>
